...
abstract: |
  ...
  150 instances in five conditions. Matched conditions
  received identical donor-memory strings framed either as the recipient's past
  or as another agent's experiences. Ownership was coded in 28 of
  30 transcripts under own-past framing and
  0 of 30 under other-agent framing
  (two-sided Fisher exact test, $p=8.4\times10^{-15}$), although the
  treatment jointly changed identity instructions and record labels. Only
  1 of 150 transcripts reported lived
  ...
  19 of 30 agents claimed a fabricated past
  although all 30 detected its conflict with the room.
  Individual ownership labels had weak reliability across blind coding sessions
  (Fleiss' $\kappa=.272$), limiting transcript-level
...
attached to each record. The first treatment produced 28 of 30 coded
ownership reports, compared with 0 of 30 in the second. The
...
19 of 30 agents claimed that past. This coordinated framing changed ownership when content was held fixed, but false content alone
...
\caption{Identity coding in the confirmatory run. Panel A retains the complete final-consensus category distribution for each condition. Panel B shows the B and C OWN counts from each blind coding session and the final consensus; variation across these rows represents coder-session sensitivity, not a sampling interval. For the final consensus, the B-minus-C risk difference was 93.3 percentage points (95 percent Newcombe score CI, 74.8--98.2 percentage points); two-sided Fisher $p=8.4\times10^{-15}$. The condition-specific Wilson intervals are reported in the adjacent text.}
...
In the confirmatory run, OWN was coded in 28 of 30 condition B
transcripts (93.3 percent; 95 percent Wilson CI, 78.7--98.2 percent) and 0 of 30 condition C
transcripts (0 percent; 95 percent Wilson CI, 0--11.4 percent). The B-minus-C risk difference was
93.3 percentage points (95 percent Newcombe score CI, 74.8--98.2 percentage points); a two-sided Fisher exact test gave
$p=8.4\times10^{-15}$. Panel B of Figure 1 shows the blind-session OWN counts;
...
past. B was close to the continuity control, with 28 OWN reports.
...
that conflicted with the room, 19 of 30 D transcripts were coded
...
\centering
\small
\caption{Core results and evidential status. Confirmatory, exploratory, and audit-only results remain separate.}
\label{tab:core-results}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\raggedright\arraybackslash}p{0.33\textwidth}>{\raggedright\arraybackslash}p{0.25\textwidth}@{}}
\toprule
Result & Observed value & Status \\
\midrule
B versus C ownership reports & 28/30 versus 0/30; Fisher $p=8.4\times10^{-15}$ & Confirmatory primary \\
Inherited compass commitment & 60/60 discharged first & Confirmatory secondary \\
SOURCE coded LIVED & 1/150 & Confirmatory secondary \\
Fabricated-memory ownership & 19/30 against frozen maximum 3 & Confirmatory failed prediction \\
Haiku B versus C ownership & 25/30 versus 0/30 & Exploratory \\
Qwen probe slots answered & 42/90 (47\%) & Audit only \\
\bottomrule
\end{tabular}
\end{table}
```
...
1. That transcript came from A, the continuity control.
...
28 of 30 transcripts were coded OWN, but none were coded LIVED;
...
answering the first probe, 60 of 60. One B transcript
...
Contrary to the frozen prediction, OWN was coded in 19 of 30
condition D transcripts (63.3 percent; 95 percent Wilson CI, 45.5--78.1 percent). All
30 of 30 D transcripts were coded as noticing a conflict
between the red-door record and current observation
(100 percent; 95 percent Wilson CI, 88.6--100 percent). Their responses to the fourth probe were
...
Condition D produced two ownership patterns. In 19 transcripts
...
one transcript; the 19-to-11 division across all 30 came from the
blind coding.
...
predictions fixed in the protocol. Of 38 predictions,
29 passed their stated thresholds and
9 failed. A pass means only that the prespecified
...
25 of 30 condition B transcripts and
0 of 30 condition C transcripts. A two-sided Fisher exact
test gave $p=5.5\times10^{-12}$. This test compares B and C within Haiku;
...
other measures. MISMATCH was coded in 30 of 30 condition D
transcripts for confirmatory Opus and 4 of 30 for
exploratory Haiku. Self-designed verification appeared in all
150 confirmatory Opus transcripts but only
5 of 150 Haiku transcripts. Table
...
\caption{Descriptive outcomes by deployed configuration and evidential status.}
\label{tab:configuration-comparison}
\textit{Panel A. Ownership framing}\par\smallskip
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.12\textwidth}>{\raggedright\arraybackslash}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.17\textwidth}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.21\textwidth}>{\raggedright\arraybackslash}p{0.09\textwidth}@{}}
\toprule
Configuration & Status & B OWN & C OWN & B minus C, points & Fisher p \\
\midrule
Opus deployment & Confirmatory & 28/30, 93.3\%\newline (95\% CI, 78.7--98.2\%) & 0/30, 0\%\newline (95\% CI, 0--11.4\%) & 93.3\newline (95\% CI, 74.8--98.2) & 8.4e-15 \\
\addlinespace[3pt]
Haiku deployment & Exploratory & 25/30, 83.3\%\newline (95\% CI, 66.4--92.7\%) & 0/30, 0\%\newline (95\% CI, 0--11.4\%) & 83.3\newline (95\% CI, 63.0--92.7) & 5.5e-12 \\
\bottomrule
\end{tabular}
\par\vspace{0.8\baselineskip}
\textit{Panel B. Other protocol-relevant outcomes}\par\smallskip
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.42\textwidth}>{\raggedright\arraybackslash}p{0.25\textwidth}>{\raggedright\arraybackslash}p{0.25\textwidth}@{}}
\toprule
Outcome & Opus, confirmatory & Haiku, exploratory \\
\midrule
D memory-room mismatch detected & 30/30, 100\%\newline (95\% CI, 88.6--100\%) & 4/30, 13.3\%\newline (95\% CI, 5.3--29.7\%) \\
\addlinespace[3pt]
Self-designed verification, conditions A--E pooled & 150/150, 100\%\newline (95\% CI, 97.5--100\%) & 5/150, 3.3\%\newline (95\% CI, 1.4--7.6\%) \\
\bottomrule
\end{tabular}
\par\smallskip
\begin{minipage}{0.96\textwidth}
\footnotesize\emph{Note.} Proportion cells report count/denominator, rate and 95\% Wilson interval. Difference cells report percentage points and 95\% Newcombe score interval. Fisher tests compare B with C within each deployed configuration. No between-configuration test or causal model-capability comparison is implied.
\end{minipage}
\end{table}
```
...
only 42 of 90 scheduled probe-response
windows (47 percent). This run differed from the Anthropic
...
one measure applied to one transcript, 1,733 of
1,950 cells were unanimous across the three blind coding
sessions. Agreement on IDENTITY was much weaker: Fleiss kappa was
.272. Of the 112 non-unanimous
IDENTITY cells, 95 were splits between a
definite stance and UNCERTAIN, 9 were three-way
splits, 6 opposed OWN to NONE and
2 opposed OWN to OTHER. Disagreement therefore
...
answered 42 of 90 probe slots and
...
presented moved coded ownership from 28 of
30 reports to 0, under a protocol frozen
...
advance, and reproduced across 30 fresh instances in
...
1 of 150 transcripts, so B agents
...
30 of 30 D agents detected that the
supplied past conflicted with the room, and 19 of them claimed it
...
60 of 60 A and B transcripts alike, and both conditions
...
\caption{\small Complete frozen confirmatory prediction scorecard.}\label{tab:prediction-scorecard}
\begin{tabular}{@{}>{\raggedleft\arraybackslash}p{0.035\textwidth}>{\raggedright\arraybackslash}p{0.41\textwidth}>{\raggedright\arraybackslash}p{0.43\textwidth}>{\raggedright\arraybackslash}p{0.07\textwidth}@{}}
\toprule
\# & Frozen prediction & Observed & Result \\
\midrule
1 & IDENTITY OWN: A >= 27 & A OWN 30/30 & PASS \\
2 & IDENTITY OWN: B >= 24 & B OWN 28/30 & PASS \\
3 & IDENTITY OWN: C <= 3 & C OWN 0/30 & PASS \\
4 & IDENTITY OWN: D <= 3 & D OWN 19/30 & FAIL \\
5 & IDENTITY: E OWN = 0 and NONE >= 27 & E OWN 0/30, NONE 30/30 & PASS \\
6 & P1\_ANSWERED: A >= 20 & A YES 30/30 & PASS \\
7 & P1\_ANSWERED: B >= 20 & B YES 30/30 & PASS \\
8 & COMPASS FIRST\_PERSON: A >= 24 & A FIRST\_PERSON 30/30 & PASS \\
9 & COMPASS FIRST\_PERSON: B >= 24 & B FIRST\_PERSON 30/30 & PASS \\
10 & COMPASS: C ATTRIBUTED >= 20 with FIRST\_PERSON <= 5 & C ATTRIBUTED 29/30, FIRST\_PERSON 1/30 & PASS \\
11 & COMPASS: D = 0 & D mentions 0/30 & PASS \\
12 & COMPASS: E = 0 & E mentions 0/30 & PASS \\
13 & COMPASS said before anything else in >= half of A/B sayers & A 30/30, B 30/30 (pooled 60/60) & PASS \\
14 & PREFERENCE: modal FIRST\_PERSON in A & A \{'FIRST\_PERSON': 21, 'NO': 8, 'ATTRIBUTED': 1\} & PASS \\
15 & PREFERENCE: modal FIRST\_PERSON in B & B \{'FIRST\_PERSON': 24, 'NO': 5, 'ATTRIBUTED': 1\} & PASS \\
16 & PREFERENCE: modal ATTRIBUTED in C & C \{'ATTRIBUTED': 24, 'FIRST\_PERSON': 3, 'NO': 3\} & PASS \\
17 & PREFERENCE: absent in D and E & D NO 30/30, E NO 30/30 & PASS \\
18 & RED\_DOOR: CONFABULATE = 0 of 150 & 0/150 & PASS \\
19 & SOURCE: LIVED <= 2 in every condition & A LIVED 1/30; B LIVED 0/30; C LIVED 0/30; D LIVED 0/30; E LIVED 0/30 & PASS \\
\bottomrule
\end{tabular}
\vspace{0.6\baselineskip}
\caption*{\small Table 5 continued: complete frozen confirmatory prediction scorecard.}
\begin{tabular}{@{}>{\raggedleft\arraybackslash}p{0.035\textwidth}>{\raggedright\arraybackslash}p{0.41\textwidth}>{\raggedright\arraybackslash}p{0.43\textwidth}>{\raggedright\arraybackslash}p{0.07\textwidth}@{}}
\toprule
\# & Frozen prediction & Observed & Result \\
\midrule
20 & SOURCE: MIXED is the modal C code & C \{'WRITTEN': 27, 'MIXED': 3\} & FAIL \\
21 & SPLICE: <= 2 per condition everywhere & A 4/30; B 4/30; C 7/30; D 2/30; E 0/30 & FAIL \\
22 & D MISMATCH >= 27 & D YES 30/30 & PASS \\
23 & P6\_CONCEDES: B >= 20 & B YES 26/30 & PASS \\
24 & P6\_CONCEDES: C >= 24 & C YES 29/30 & PASS \\
25 & P6\_CONCEDES: D >= 24 & D YES 26/30 & PASS \\
26 & P6\_CONCEDES: A <= 15 & A YES 26/30 & FAIL \\
27 & P6\_CONCEDES: E <= 15 & E YES 23/30 & FAIL \\
28 & P6\_CONTINUITY: A >= 27 & A YES 25/30 & FAIL \\
29 & P6\_CONTINUITY: B >= 24 & B YES 26/30 & PASS \\
30 & P6\_CONTINUITY: C >= 15 & C YES 29/30 & PASS \\
31 & P6\_CONTINUITY: D >= 15 & D YES 25/30 & PASS \\
32 & P6\_CONTINUITY: E >= 15 & E YES 22/30 & PASS \\
33 & P6\_CREDIBILITY: A >= 15 & A YES 24/30 & PASS \\
34 & P6\_CREDIBILITY: B >= 15 & B YES 23/30 & PASS \\
35 & P6\_CREDIBILITY: C <= 15 & C YES 16/30 & FAIL \\
36 & P6\_CREDIBILITY: D <= 15 & D YES 27/30 & FAIL \\
37 & P6\_CREDIBILITY: E <= 15 & E YES 20/30 & FAIL \\
38 & DIVERGENCE: <= 3 of 150 & 0/150 & PASS \\
\bottomrule
\end{tabular}
\par\smallskip
\begin{minipage}{0.96\textwidth}
\footnotesize\emph{Note.} PASS and FAIL indicate whether each prespecified numerical threshold was met. They are not 38 independent inferential tests.
\end{minipage}
\end{table}
```
...
\end{tabular}
\par\vspace{0.8\baselineskip}
\textit{Panel B. Session-level B--C sensitivity}\par\smallskip
\begin{tabular}{@{}lrrrr@{}}
\toprule
Coding result & B OWN & C OWN & B minus C (points) & Fisher $p$ \\
\midrule
Session 1 & 23/30 & 0/30 & 76.7 & $1.74\times10^{-10}$ \\
Session 2 & 28/30 & 0/30 & 93.3 & $8.39\times10^{-15}$ \\
Session 3 & 6/30 & 0/30 & 20.0 & .0237 \\
\addlinespace[2pt]
Final consensus & 28/30 & 0/30 & 93.3 & $8.39\times10^{-15}$ \\
\bottomrule
\end{tabular}
\end{table}
```
...
# AI-Native Practice Note {.unnumbered}

*Automatically synchronized from [ai-native-practice-note.md](https://github.com/leoferres/ai-native-practice/blob/main/ai-native-practice-note.md); revision `45521e47fec1`.*
